<template>
  <he-article-detail>
    <template slot="articleTitle">CSS命名规范-BEM</template>
    <template slot="articleContent">
      <p>BEM是由Yandex公司推出的一套CSS命名规范，官方是这么描述它的：</p>
      <blockquote>
        <p>BEM是一种让你可以快速开发网站并对此进行多年维护的技术。</p>
      </blockquote>
      <p>一开始，Yandex公司推出的BEM，包括了规范以及其配套构建工具。如今提到的BEM主要是指其中的规范，在<a class="external-link" href="http://getbem.com/" rel="nofollow">BEM最新的推广页</a>中，对其的描述为：</p>
      <blockquote>
      ...
      <h2 id="CSS命名规范-BEM-BEM解决的问题">BEM解决的问题</h2>
...
<div class="page-btn">
  ...
  <!-- ... -->
   <button type="button" class="page-btn__next">下一页</button>
      ...
      <p>上面我们用双下划线来明确区分模块名和元素名，当然也可以用单下划线，比如<code>page-btn_prev</code>和 <code>codepage-btn_next</code>。我们只需保留BEM的思想，其命名规范可以任意变通。</p>
...
<div class="page-btn">
  ...
  <!-- ... -->
      ...
      <p>分页组件有个ul列表名为：<code>page-btn__list</code>，列表里面存放每一页的按钮，名为：<code>btn__list__item__link</code>page-，这是不对的。</p>
      ...
      <pre class="brush:css">.blockName-elementName--modifierName { /* ... */ }</pre>
      <p>还有单下划线：</p>
      <pre class="brush:css">.block-name_element-name--modifierName { /* ... */ }</pre>
      <p>还有修饰器名用单横线连接：</p>
      <pre class="brush:css">.blockName__elementName-modifierName { /* ... */ }</pre>
...
.page-contact .page-btn {}
      ...
      <pre class="brush:xml">
<!-- 发帖页面 -->
<span ng-repeat="post in postData track by post.id" ng-if="$index === 0" class="page-post__post-item" ng-class="{'page-post__post-item--even': $even}" popover-content="">
...
<span ng-repeat="post in postData track by post.id"
      ...
      <p><a class="external-link" href="https://webpack.github.io/" rel="nofollow">webpack</a>加载器css-loader，可在js中读取css样式，自2015年4月份起，该插件加入了placeholder功能，使得该插件可以解决CSS作用域的问题，原理也就是给元素的名称加入唯一的标识。</p>
      <pre class="brush:css">
/* 分页组件 */
:local(.prev) {}
                                </pre>
...
// ...
      ...
      <p><code>styles.prev</code>返回的是一串独一无二且随机的字符串，该字符串对应着样式文件中的选择器。这名字有悖语义化，但css-loader支持配置字符串的生成格式，有兴趣的童鞋可以看看这篇文章：<a class="external-link" href="https://medium.com/seek-ui-engineering/the-end-of-global-css-90d2a4a06284" rel="nofollow">The End of Global CSS</a>。</p>
      <h2>BEM规范相关资源</h2>
      <p><a class="external-link" href="http://blog.lxjwlt.com/front-end/2015/10/08/why-bem.html" rel="nofollow">http://blog.lxjwlt.com/front-end/2015/10/08/why-bem.html</a></p>
      <p><a class="external-link" href="https://www.ibm.com/developerworks/cn/web/1512_chengfu_bem/" rel="nofollow">https://www.ibm.com/developerworks/cn/web/1512_chengfu_bem/</a></p>
      <p><a class="external-link" href="https://en.bem.info/methodology/quick-start/" rel="nofollow">https://en.bem.info/methodology/quick-start/</a></p>
      <p><a class="external-link" href="http://getbem.com/" rel="nofollow">http://getbem.com/</a></p>
    </template>
  </he-article-detail>
</template>
