...
<template>
  <div class="pagination">
    <ul class="pagination-link">
      <li class="page-item prev-page" :class="{disabled: innerPageNumber === 1}" @click="prevPage">
        <a class="page-link" href="javascript:;" v-html="prevPageStr"></a>
      </li>
      <li class="page-item" :class="[page.extraClass, {current: innerPageNumber === page.pageNumber}]" v-for="(page, index) in pages" :key="index">
        <a class="page-link" href="javascript:;" @click="page.pageNumber > 0 && goPage(page.pageNumber)">{{page.pageStr}}</a>
      </li>
      <li class="page-item next-page" :class="{disabled: innerPageNumber === totalPage}" @click="nextPage">
