<template>
  <div class="article-item">
    <div class="article-title">
      <h1 class="title"><a class="link title-link" :href="semanticLink !== '' ? '/article/'+ semanticLink + '.html' : false">{{title}}</a></h1>
    </div>
    <div class="article-info">
      <div class="article-attribute-info">
        ...
        <dl class="info-item">
          ...
          <dd class="item-value">{{clickCount}}</dd>
        </dl>
        <dl class="info-item">
          <dt class="item-name">评论:</dt>
          <dd class="item-value">{{commentCount}}</dd>
        </dl>
      </div>
